...
class AppText {
  ...
  TextTheme toTextTheme(bool isDark) {
    ...
    final color = isDark ? colors.darkPrimaryText : colors.lightPrimaryText;
    return TextTheme(
